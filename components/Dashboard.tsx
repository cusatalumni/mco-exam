                        ...
                        <div className="space-y-3">
                            {processedPurchasedExams.length > 0 ? processedPurchasedExams.map(exam => {
                                ...
                                <div className="text-center py-6 text-slate-500">
                                    ...
                                    <a href={browseExamsUrl} target="_blank" rel="noopener noreferrer" className="mt-2 inline-block text-sm font-semibold text-cyan-600 hover:text-cyan-800">
                                        Browse Exams <ArrowRight size={14} className="inline"/>
                                    </a>
                                </div>
                            )}
                        </div>
