...
const MASTER_BOOK_LIST: RecommendedBook[] = [
    {
        id: 'book-cpc-guide',
        title: 'Official CPC Certification Study Guide',
        description: 'The most comprehensive guide from AAPC to prepare for your certification. Includes practice questions and detailed explanations.',
    ...
    },
    {
        ...
        description: 'A market-leading text known for its easy-to-understand approach, helping you master all coding skill levels.',
        imageUrl: 'https://placehold.co/300x400/003366/FFFFFF/png?text=Bucks+Step-by-Step',
        affiliateLinks: { com: 'https://www.amazon.com/dp/0323797435?tag=mykada-20', in: 'https://www.amazon.in/dp/0323797435?tag=httpcodingonl-21', ae: 'https://amzn.to/46QduHx' }
    },
    {
        id: 'book-med-term',
        title: 'Medical Terminology For Dummies',
        description: 'Get a handle on the confusing terms in medicine. This guide makes learning medical terminology simple and fun.',
        imageUrl: 'https://placehold.co/300x400/003366/FFFFFF/png?text=Med+Term',
        affiliateLinks: { com: 'https://www.amazon.com/dp/1119752392?tag=mykada-20', in: 'https://www.amazon.in/dp/1119752392?tag=httpcodingonl-21', ae: 'https://amzn.to/46QduHx' }
    },
    {
        id: 'book-icd10-handbook',
        title: 'ICD-10-CM/PCS Coding Handbook',
        description: 'An essential resource from the American Hospital Association for learning and applying ICD-10 codes accurately.',
